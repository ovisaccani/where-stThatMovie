...
import {
	MovieRapidDBMoviesResponse,
	StreamingInfo,
} from "../interfaces/movieRapidInterface";
...
export const useMovieStreamingDetails = (movieId: number) => {
	...
	const getMovieStreamingDetails = async () => {
		const streamingInfoPromise =
			peliculaRapidBd.get<MovieRapidDBMoviesResponse>(``, {
				params: { tmdb_id: `movie/${movieId}` },
			});
